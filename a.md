...
今回は日々小さく思いつくアイディアの源泉を溜め、膨らませるためのメモ管理術について掘り下げていきます。
...
| レベル | 説明 |
| --- | --- |
| アイディアノート | 思いつきのメモや記事をスクラップするノートです。
他インターネット記事では思いつきのメモを一時メモ、記事のスクラップを文献メモで分けられています。私は分けない方が使いやすかったためアイディアノートとしてまとめています。 |
| パーマネントノート | アイディアノートをまとめて文書化をここで行います。
記事の「章」に当たるものとして、アイディアをまとめます。 |
| ストラクチャーノート | パーマネントノートをまとめて文書化します。
これが記事の内容となります。 |
